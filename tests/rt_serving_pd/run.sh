...
pipeline = list(csv.DictReader(open(sys.argv[4])))
decode1 = json.load(open(sys.argv[5]))
decode2 = json.load(open(sys.argv[6]))
seeded_summary_1 = json.load(open(sys.argv[7]))
seeded_summary_2 = json.load(open(sys.argv[8]))
seeded_metrics_1 = open(sys.argv[9]).read()
seeded_metrics_2 = open(sys.argv[10]).read()
seeded_metadata_1 = json.load(open(sys.argv[11]))
seeded_metadata_2 = json.load(open(sys.argv[12]))
